...
<table width='100%' align='center' cellpadding='10'>
    <tr>
        ...
        <?php while ($siswa = mysqli_fetch_array($siswaQ)) : ?>
            ...
            ?>
            <td width='50%'>
                <div style='width:10.4cm;border:1px solid #666; page-break-inside: avoid !important; padding-top:1px'>
                    ...
                    <table style="text-align:left; width:100%">
                        <tr>
                            <td style="text-align:left; vertical-align:top; width:60px" rowspan="8">
                                <?php
                                if ($siswa['foto'] <> '') {
                        ...
                        <tr>
                            ...
                            <td class="ukuran" valign='top'>: <?= $siswa['ruang'] ?>
                                <div style="padding-top: 12px; padding-left: 79px;" class="ttd"><img src='<?php echo '../../dist/img/ttd.png' . '?date=' . time(); ?> ?>' height='40px'></div>
                            </td>
                        </tr>
